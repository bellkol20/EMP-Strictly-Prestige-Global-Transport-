...
export default function HomePage() {
  return (
    <>
      <section className="hero-atmosphere relative overflow-hidden text-[var(--mist)] min-h-[100svh] md:min-h-0">
        <div className="absolute inset-0 animate-veil bg-[radial-gradient(circle_at_80%_20%,rgba(243,238,230,0.06),transparent_35%)]" />
        <div className="relative mx-auto flex min-h-[100svh] max-w-6xl flex-col justify-end px-6 pb-16 pt-28 md:min-h-full md:justify-end md:px-8 md:pb-20 md:pt-24">
